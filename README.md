<a href="https://pub.dartlang.org/packages/pdc_wallet"><img alt="pub version" src="https://img.shields.io/pub/v/pdc_wallet.svg?style=flat-square"></a>
...
[Flutter Packages](https://pub.dartlang.org/packages/pdc_wallet#-installing-tab-)

## Examples

```dart
import 'package:pdc_wallet/pdc_wallet.dart';
